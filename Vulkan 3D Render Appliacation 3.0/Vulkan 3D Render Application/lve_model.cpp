...
namespace lve {
	...
	LveModel::LveModel(MyEngineDevice& device, const LveModel::Builder& builder) : lveDevice{ device } {
	...
	std::unique_ptr<LveModel> createModelFromFile(MyEngineDevice& device, const std::string& filepath) {
	...
	void LveModel::draw(VkCommandBuffer commandBuffer) {
		if (hasIndexBuffer) {
			vkCmdDraw(commandBuffer, indexCount, 1, 0, 0, 0);
		}
		else {
	...
	void LveModel::bind(VkCommandBuffer commandBuffer) {
		VkBuffer buffers[] = {indexBuffer->getBuffer()};
